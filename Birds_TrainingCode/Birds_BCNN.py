...
#######################################
# Usage: 
# Accuracy of the model on test set is 52.12%.
...
def model_fn(features, labels, mode):
	...
	dropout_1 = tf.layers.dropout(inputs = phi_I, rate = Dropout_Rate, training=mode == tf.estimator.ModeKeys.TRAIN)
	# print(dropout_1)
...
def main(unused_argv):
	...
	birds_classifier = tf.estimator.Estimator(
		model_fn = model_fn,
		model_dir = "Models/Feature_Vector_BCNN/")
